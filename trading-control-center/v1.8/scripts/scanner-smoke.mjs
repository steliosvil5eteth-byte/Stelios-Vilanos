...
const s={minScore:95,minRR:1,maxHold:20,wTrend:30,wMomentum:25,wVolume:20,wVolatility:15,wRsi:10,slippageBps:5,commissionBps:2,stopLossPct:5,targetMinPct:5,targetMaxPct:10,monthlyLossPct:10,scanMinBars:90,scanMinOosTrades:0,scanMinOosAvgR:-5,scanMinOosPF:0};
