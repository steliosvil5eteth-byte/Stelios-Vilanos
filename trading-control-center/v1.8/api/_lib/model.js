...
export const STRATEGY_KEYS=['minScore','minRR','maxHold','wTrend','wMomentum','wVolume','wVolatility','wRsi','slippageBps','commissionBps','riskPct','stopLossPct','targetMinPct','targetMaxPct','monthlyLossPct','barIntervalMinutes','dailyLoss','maxPositionPct','maxExposurePct','maxOpen','minAvgDollarVolume','scanMinBars','scanMinOosTrades','scanMinOosAvgR','scanMinOosPF'];
